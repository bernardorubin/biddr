...
ActiveRecord::Schema.define(version: 20170328163821) do
  ...
  create_table "auctions", force: :cascade do |t|
    ...
    t.integer  "user_id"
    t.float    "currentprice", default: 1.0
    t.string   "aasm_state"
  ...
  create_table "bookmarks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["auction_id"], name: "index_bookmarks_on_auction_id", using: :btree
  ...
  add_foreign_key "bookmarks", "auctions"
